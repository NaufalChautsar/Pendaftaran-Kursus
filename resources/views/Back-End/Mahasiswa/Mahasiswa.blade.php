            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <!-- Notification -->
                        ...
                        @endif
                    <!-- Notification -->
                    <h4 class="fw-bold py-3 mb-4">Data Mahasiswa</h4>
                    <div class="card">
                        <div class="d-flex justify-content-between">
                            <h5 class="card-header">Table Mahasiswa</h5>
                            <a href="{{ route('mahasiswa.create') }}" class="btn btn-success me-4 my-3">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('mahasiswa.edit', $user->user_id ) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>

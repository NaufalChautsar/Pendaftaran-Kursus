        ...
        <div class="layout-page">
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Tambah Mahasiswa</h4>
                    <div class="row">
                        <div class="col-xl">
                            <div class="card mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="nama" class="form-control" id="basic-default-company" value="{{ old('nama') }}" autofocus/>
                                                    @error('nama')
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" name="npm" class="form-control" id="basic-default-company" value="{{ old('npm') }}"/>
                                                    @error('npm')
                                                        <div id="defaultFormControlHelp" class="form-text text-danger">
                                                            {{ $message }}
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="kelas" class="form-control" id="basic-default-company" value="{{ old('kelas') }}"/>
                                                    @error('kelas')
                                                        <div id="defaultFormControlHelp" class="form-text text-danger">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="password" class="form-control" id="basic-default-company" value="{{ old('password') }}"/>
                                                    @error('password')
                                                        <div id="defaultFormControlHelp" class="form-text text-danger">
                                                            {{ $message }}
                                                        </div>

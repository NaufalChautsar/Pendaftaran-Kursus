        ...
        <div class="layout-page">
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Tambah Kursus</h4>
                    <div class="row">
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('kursus.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nama_kursus" class="form-control" id="basic-default-fullname" value="{{ old('nama_kursus') }}" autofocus/>
                                            @error('nama_kursus')
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" name="mulai_kursus" class="form-control" id="basic-default-company" value="{{ old('mulai_kursus') }}"/>
                                                    @error('mulai_kursus')
                                                        <div id="defaultFormControlHelp" class="form-text text-danger">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" name="selesai_kursus" class="form-control" id="basic-default-company" value="{{ old('selesai_kursus') }}"/>
                                        ...
                                        <textarea id="basic-default-message" name="keterangan" class="form-control">{{ old('keterangan') }}</textarea>
                                        @error('keterangan')
                                            <div id="defaultFormControlHelp" class="form-text text-danger">
                                                {{ $message }}
                                            </div>

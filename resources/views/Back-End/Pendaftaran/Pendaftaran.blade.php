            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <!-- Notification -->
                        ...
                        @endif
                    <!-- Notification -->
                    <h4 class="fw-bold py-3 mb-4">Data Pendaftaran Kursus</h4>
                    <div class="card">
                        <div class="d-flex justify-content-between">
                            <h5 class="card-header">Table Pendaftaran Kursus</h5>
                        </div>
                                    ...
                                    @forelse ($pendaftaranKursus as $pendaftaran)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <strong>{{ $pendaftaran->user->npm }}</strong>
                                            </td>
                                            <td>
                                                <i class="fab fa-angular fa-lg text-danger"></i> 
                                                <strong>{{ $pendaftaran->user->nama }}</strong>
                                            </td>
                                            <td>
                                                <i class="fab fa-angular fa-lg text-danger"></i> 
                                            ...
                                            <td>
                                                <i class="fab fa-angular fa-lg text-danger"></i> 
                                                <strong>{{ date('d M Y', strtotime($pendaftaran->kursus->mulai_kursus)) }}</strong>
                                            </td>
                                            <td>
                                                <i class="fab fa-angular fa-lg text-danger"></i> 
                                                <strong>{{ date('d M Y', strtotime($pendaftaran->kursus->selesai_kursus)) }}</strong>
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('pendaftaranKursus.edit', $pendaftaran->pendaftaran_id ) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
